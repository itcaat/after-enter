...
const russianStages: Stage[] = [
  {
    ...
    substeps: [
      ...
      { label: "HID-сигнал", detail: "Физическая или экранная клавиатура превращает действие в системный код ввода.", signal: "switch / touch → HID report", ms: 1, exchanges: 0 },
...
const englishStages: Stage[] = [
  {
    ...
    substeps: [
      ...
      { label: "HID signal", detail: "A physical or on-screen keyboard turns the action into an operating-system input code.", signal: "switch / touch → HID report", ms: 1, exchanges: 0 },
